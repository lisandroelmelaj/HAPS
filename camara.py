def calcular_vision_haps():
    ...
    focal_lente_mm = 3.2           # Distancia focal en mm (f)
    pixel_pitch_um = 12         # Tamaño del píxel en micrones (p) - (Ej: RPi HQ es 1.55)
    res_ancho_px = 256        # Resolución del sensor (Ancho)
    res_alto_px = 192            # Resolución del sensor (Alto)
    
    # Objeto que queremos medir en el suelo (ejemplo: un foco de incendio o un auto)
    objeto_suelo_m = 40          # Tamaño del objeto en metros
